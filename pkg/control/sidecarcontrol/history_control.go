...
func (r *realControl) getPatch(s *appsv1alpha1.SidecarSet) ([]byte, error) {
	...
	setSidecarSetSpecRevision(specCopy, spec)
...
func (r *realControl) GetHistorySidecarSet(sidecarSet *appsv1alpha1.SidecarSet, revisionName string) (*appsv1alpha1.SidecarSet, error) {
	...
	if err != nil {
		klog.Errorf("Failed to encode sidecarSet, err %v", err)
		return nil, err
	}
	...
	if err := ReHashSidecarSet(restoredSidecarSet); err != nil {
		return nil, err
	}
	return restoredSidecarSet, nil
}

func setSidecarSetSpecRevision(dst, src map[string]interface{}) {
